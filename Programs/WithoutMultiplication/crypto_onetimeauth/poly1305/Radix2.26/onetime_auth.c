#include "stdint.h"
extern void karatsuba226_130_inplace(unsigned int *, unsigned int *);
...
void freeze_130(unsigned int h[17]) {
...
int crypto_onetimeauth(unsigned char *out, const unsigned char *in,
  ...
  if (inlen > 0) {
    ...
    karatsuba226_130(h, h,
                     r); // multiply state with the secret key modulo 2^130-5
  }

  // go back to radix 2.8
  toradix28_130(h);

  freeze_130(h); // calculate mod 2^130-5
