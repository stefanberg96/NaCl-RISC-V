...
// subtraction of a and b (TODO check if negative numbers are expected, since this could screw with my karatsuba mult)
...
// TODO make into karatsuba with split 130 125 using modified assembly from poly1305
...
// seems to be xoring r and s with a b (which depends on input)
