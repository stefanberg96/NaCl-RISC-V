...
void recip226(unsigned int out[10], const unsigned int z[10]) {
  ...
  /* 2 */ karatsuba226(z11, z, z);
  /* 4 */ karatsuba226(t0, z11, z11);
  /* 8 */ karatsuba226(t0, t0, t0);
  /* 9 */ karatsuba226(t0, t0, z);
  /* 11 */ karatsuba226(z11, z11, t0);
  /* 22 */ karatsuba226(t1, z11, z11);
  /* 2^5 - 2^0 = 31 */ karatsuba226(t0, t1, t0);

  /* 2^6 - 2^1 */ karatsuba226(t1, t0, t0);
  /* 2^7 - 2^2 */ karatsuba226(t1, t1, t1);
  /* 2^8 - 2^3 */ karatsuba226(t1, t1, t1);
  /* 2^9 - 2^4 */ karatsuba226(t1, t1, t1);
  /* 2^10 - 2^5 */ karatsuba226(t1, t1, t1);
  /* 2^10 - 2^0 */ karatsuba226(t1, t0, t1); // last use z2_5_0

  /* 2^11 - 2^1 */ karatsuba226(t0, t1, t1);
  /* 2^12 - 2^2 */ karatsuba226(t0, t0, t0);
  /* 2^20 - 2^10 */ for (i = 2; i < 10; i += 2) {
    karatsuba226(t0, t0, t0);
    karatsuba226(t0, t0, t0);
  }
  /* 2^20 - 2^0 */ karatsuba226(t0, t1, t0);

  /* 2^21 - 2^1 */ karatsuba226(t2, t0, t0);
  /* 2^22 - 2^2 */ karatsuba226(t2, t2, t2);
  /* 2^40 - 2^20 */ for (i = 2; i < 20; i += 2) {
    karatsuba226(t2, t2, t2);
    karatsuba226(t2, t2, t2);
  }
  /* 2^40 - 2^0 */ karatsuba226(t0, t0, t2); // last use of z2_20_0

  /* 2^41 - 2^1 */ karatsuba226(t0, t0, t0);
  /* 2^42 - 2^2 */ karatsuba226(t0, t0, t0);
  ...
  /* 2^51 - 2^1 */ karatsuba226(t0, t2, t2);
  /* 2^52 - 2^2 */ karatsuba226(t0, t0, t0);
  ...
  /* 2^101 - 2^1 */ karatsuba226(t0, t1, t1);
  /* 2^102 - 2^2 */ karatsuba226(t0, t0, t0);
  ...
  /* 2^201 - 2^1 */ karatsuba226(t0, t0, t0);
  /* 2^202 - 2^2 */ karatsuba226(t0, t0, t0);
  ...
  /* 2^251 - 2^1 */ karatsuba226(t0, t0, t0);
  /* 2^252 - 2^2 */ karatsuba226(t0, t0, t0);
  /* 2^253 - 2^3 */ karatsuba226(t0, t0, t0);
  /* 2^254 - 2^4 */ karatsuba226(t0, t0, t0);
  /* 2^255 - 2^5 */ karatsuba226(t0, t0, t0);
